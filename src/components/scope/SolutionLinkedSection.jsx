  ...
  return (
    <div className="space-y-6 mt-8">
      ...
      <div>
        ...
        <h3 className="text-sm font-semibold text-[var(--text-secondary)] uppercase tracking-wider mb-4">3rd Party Integrations</h3>
        <div className="bg-[var(--bg-secondary)] border border-[var(--border)] rounded-xl overflow-hidden">
          <table className="w-full text-sm">
            <thead><tr className="bg-blue-500/20/50">
              ...
              <th className="text-left px-4 py-3 text-xs text-[var(--text-secondary)] font-semibold w-32">Source</th>
            </tr></thead>
            <tbody>
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {(!data.upas || data.upas.length === 0) ? (
                <tr><td colSpan={4} className="px-4 py-6 text-center text-[var(--text-muted)] text-sm">No UPAs — add them in the Marketplace & UPAs tab</td></tr>
              ) : data.upas.map(u => (
